...
export async function GET({ locals }) {
  ...
  return json(bereiche.map(b => ({
    ...b, _id: b._id.toString(), userId: b.userId.toString()
  })));
}
...
export async function POST({ request, locals }) {
  ...
  const bereich = {
    ...
    zielAnzahl:   body.zielAnzahl  ? parseInt(body.zielAnzahl)  : null,
    zielZeitraum: body.zielZeitraum || 'woche',
    erstellt:     new Date()
  };
