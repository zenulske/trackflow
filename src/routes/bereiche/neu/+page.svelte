<script>
  ...
  async function speichern() {
    ...
    if (zielAnzahl && zielTyp === "wert" && !zielEinheit.trim()) {
      fehler =
    ...
    console.log("📤 Bereich wird gespeichert:", body);
...
<div class="card border-0 shadow-sm" style="max-width:520px;">
  <div class="card-body p-4">
    ...
    >
      ...
      <span class="fw-semibold" style="color:{gewaehlt.farbe};"
        >{name || "Neuer Bereich"}</span
      >
    </div>
